...
public class SQLHelper extends SQLiteOpenHelper {
    ...
    public List<Item> listBook(){
        ...
        // cursor - permite acesso aos dados enquanto tiverem dados a serem acessados
        // rawQuery: precisa do sql (string) e da condição (string)

        try {

            if (cursor.moveToFirst()){

                //while: pré-teste (testa a condição e depois executa)
                //do while: pós-teste (executa e depois testa)
            ...
            //move o cursor para a primeira coluna de dados
